...
public class UserDAOImpli implements UserDAO {
	...
	public UserBean loginUser(String email, String password) {
		try {
			...
			throw new MedicalExeption("Invalid Username and Password");
		}
	}
	...
	public boolean registerUser(String userName, String email, String password) {
		...
		try {
			...
			throw new MedicalExeption("Email Already Exixt");
		}
		return isAdded;
	}
	...
	public boolean adminRegisterUser(String userName, String email, String password, String type) {
		...
		try {
			...
			throw new MedicalExeption("Email Already Exist");
		}
		return isAdded;
	}
	...
	public List<UserBean> getuser() {
		try {
			...
			throw new MedicalExeption("No User Present");
		}
	}
	...
	public boolean removeUser(int uId) {
		...
		try {
			...
			entityTransaction.rollback();
			throw new MedicalExeption("Invalid UserId");
		}
		return isDeleted;
	}
	...
	public boolean changePass(UserBean bean) {
		...
		try {
			...
			entityTransaction.rollback();
			throw new MedicalExeption("Unable TO change Password");
		}
		return isChanged;
	}
}
